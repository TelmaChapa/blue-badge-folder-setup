...
//Reverse Method
/*
the reverse method reverses the order of the elements in an array. It sorts it in a descending order.
*/
...
//Splice Method
/*
We use the splice method when we want to delete a certain element and/or replace them with other elements that wecreate.
*/

let darkSide = ['Darth Vader', 'Darth Plagueis', 'Emperor Palpatine', 'Count Dooku', 'General Grievous', 'Kylo Ren', 'Darth Maul'];
let removed = darkSide.splice(2, 4, "Dart Sidious", "Darth Tyranus");
...
let alphabet = " a b c d e f g h i j k l m o p";
...
console.log(over18); //if we remove 12 and 18, it should return -true-
