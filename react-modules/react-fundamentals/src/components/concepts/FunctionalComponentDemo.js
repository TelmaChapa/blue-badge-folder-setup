        ...
        <Container className="main">
            <Row>
                ...
                <h1>Functional Component</h1>
                    <h6>Functional Components are the primarily tool in React to build a small, modular piece of your page.</h6>
                <dl>
                    <dt>Can use state</dt>
                        <dd>With the 'useState' hook, functional components can now both render a display to the page and update the information to be shown to the page.</dd>
